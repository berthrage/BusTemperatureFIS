...
#------------------------DRAW METHODS-------------------------------
    ...
    def draw_text(self, text, x, y, size=12, color=(0,0,0),
        ...
        button_rect = font_surface.get_rect(topleft=(x, y))
        ...
        # Finally! BLIT!
        self.screen.blit(font_surface, button_rect)

        return button_rect

    def draw_rect(self, color, rect, linewidth=0, borderRadius=0):
        pygame.draw.rect(self.screen, color, rect, linewidth, borderRadius)

    def typeRect(self):
        return pygame.rect.Rect(100, 100, 100, 100)
